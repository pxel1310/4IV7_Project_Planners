<%-- 
    Document   : error
    Created on : 2/06/2022, 11:47:34 AM
    Author     : Jaret
--%>
...
<html>
    <head>
        ...
        <title>Maquinas Batiz -Error</title>
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="vistas/perfilPersona.jsp?id=<%=sesionusu.getAttribute("id")%>">Perfil</a>
    ...
    <nav id="navbar-main" class="navbar navbar-dark navbar-expand-md bg-dark py-3">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="https://www.cecyt9.ipn.mx#" target="_blank">
                <span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon">
                    <img id="img-nav" src="assets/img/icono.png" />
                </span><span id="spans">CECyT 9 &quot;Juan de Dios Bátiz&quot;</span></a>
    ...
    <section class="py-4 py-xl-5">
        <div class="container">
            <div class="text-center p-4 p-lg-5">
                <p class="fw-bold text-primary mb-2">Mensaje de error</p>
                <h1 class="fw-bold mb-4">Lo sentimos hubo un error</h1>
                <%
                    if(sesionusu.getAttribute("usuario") == null){          
                %> 
                <a href="index.html"><button class="btn btn-primary fs-5 me-2 py-2 px-4" type="button">Pagina principal</button></a>
                <a href="vistas/iniciarSesion.jsp"><button class="btn btn-light fs-5 py-2 px-4" type="button">Iniciar Sesión</button></a>
                <%
                    }else if(sesionusu.getAttribute("usuario") != null){          
                %>  
                <a href="vistas/inicioPersona.jsp"><button class="btn btn-primary fs-5 me-2 py-2 px-4" type="button">Inicio</button></a>
                <a href="vistas/consultarReportes.jsp"><button class="btn btn-light fs-5 py-2 px-4" type="button">Consultar Reportes</button></a>
                <%
                    }
                %>
            </div>

...
<body>
    <div class="login-card bg-white"><img class="profile-img-card" src="assets/img/icono.png">
        ...
        <form class="form-signin" method="post" name="inicio" action="servletPersona?accion=verificarPersona">
            <div>
                <input class="form-control" type="text" placeholder="Usuario" name="txtUsuario" id="usu"/>
            </div>
            <div>
                <input id="inputPassword" class="form-control" type="password" placeholder="Contraseña" name="txtPassword"/>
